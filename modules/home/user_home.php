    ...
    <div class="mcontainer">
        ...
        <div class="lg:flex lg:space-x-10">
            <div class="lg:w-3/4 lg:px-20 space-y-7">
                ...
                <?php if ($posts_data->num_rows > 0) {
                    while ($row = $posts_data->fetch_assoc()) {
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex space-x-4 lg:font-bold">
                                    <a href="#" class="flex items-center space-x-2" onclick="return false;">
                                        <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600" onclick="countClicks()">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
                                                <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                                            </svg>
                                        </div>
                                        <span id="count"><?php echo $likes_data ?></span>
                                        <div onclick="countClicks()" id="like" class="like-btn" data-id="<?php echo $row['id']; ?>">Like</div>
                                    </a>
...
<script>
    $(document).ready(function() {
        ...
        $('.like-btn').on('click', function() {
           ...
           var likes_count=parseInt(count)
           alert(likes_count);
